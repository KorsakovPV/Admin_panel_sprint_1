...
CREATE UNIQUE INDEX film_work_genre_film_work_id_genre_id_uniq ON content.film_work_genre (film_work_id, genre_id);
...
CREATE UNIQUE INDEX film_work_person_film_work_id_person_id_role_uniq ON content.film_work_person (film_work_id, person_id, role);
